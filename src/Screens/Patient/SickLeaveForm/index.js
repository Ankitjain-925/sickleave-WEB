...
class Index extends Component {
  ...
  render() {
    const { updateQues, error_section, errorChrMsg, DataprotectionRules, openCalendar } = this.state;
    return (
      <Grid
        className={
          this.props.settings &&
                ...
                <Grid item xs={12} md={11} lg={10}>
                  ...
                  <Grid item xs={12} sm={12} md={8}>
                    ...
                    {!openCalendar === true && <Grid>
                        ...
                        {updateQues && updateQues?.headache === "yes" && (<HeadacheSection updateAllEntrySec2={(e)=>{updateAllEntrySec2(e, this)}}
                        updateAllEntrySec = {(e, name)=>updateAllEntrySec(e, name, this)}
                        updateAllEntrySec1 = {(e)=>updateAllEntrySec1(e, this)}
                        ...
                        {updateQues && updateQues?.stomach_problems === "yes" && (<StomachSection updateAllEntrySec2={(e)=>{updateAllEntrySec2(e, this)}}
                        updateAllEntrySec = {(e, name)=>updateAllEntrySec(e, name, this)}
                        updateAllEntrySec1 = {(e)=>updateAllEntrySec1(e, this)}
                        updateQues = {this.state.updateQues}
                        error_section = {this.state.error_section}
                        ...
                        {updateQues && updateQues?.diarrhea === "yes" && (
                          <DiarheaaSection updateAllEntrySec2={(e)=>{updateAllEntrySec2(e, this)}}
                          updateAllEntrySec = {(e, name)=>updateAllEntrySec(e, name, this)}
                          updateAllEntrySec1 = {(e)=>updateAllEntrySec1(e, this)}
                          updateQues = {this.state.updateQues}
                          error_section = {this.state.error_section}
                        ...
                        {updateQues && updateQues?.have_fever === "yes" && ( <FeverSection updateAllEntrySec2={(e)=>{updateAllEntrySec2(e, this)}}
                          updateAllEntrySec = {(e, name)=>updateAllEntrySec(e, name, this)}
                          updateAllEntrySec1 = {(e)=>updateAllEntrySec1(e, this)}
                          updateQues = {this.state.updateQues}
                          error_section = {this.state.error_section}
                        ...
                        {updateQues && updateQues?.back_pain === "yes" && ( <BackPainSection updateAllEntrySec2={(e)=>{updateAllEntrySec2(e, this)}}
                          updateAllEntrySec = {(e, name)=>updateAllEntrySec(e, name, this)}
                          updateAllEntrySec1 = {(e)=>updateAllEntrySec1(e, this)}
                          updateQues = {this.state.updateQues}
                          error_section = {this.state.error_section}
                          Allsituation = {this.state.Allsituation}
                          errorChrMsg = {this.state.errorChrMsg}
                          DateFormat = {this.props.Settings?.setting?.date_format}
                          />)}
                        ...
                        {updateQues && updateQues?.cough_and_snees === "yes" && (
                          <SneezSection updateAllEntrySec2={(e)=>{updateAllEntrySec2(e, this)}}
                          updateAllEntrySec = {(e, name)=>updateAllEntrySec(e, name, this)}
                          updateAllEntrySec1 = {(e)=>updateAllEntrySec1(e, this)}
                          updateQues = {this.state.updateQues}
                          error_section = {this.state.error_section}
                        ...
                        {updateQues && updateQues?.feel_depressed === "yes" && (
                           <DepressedSection updateAllEntrySec2={(e)=>{updateAllEntrySec2(e, this)}}
                           updateAllEntrySec = {(e, name)=>updateAllEntrySec(e, name, this)}
                           updateAllEntrySec1 = {(e)=>updateAllEntrySec1(e, this)}
                           updateQues = {this.state.updateQues}
                           error_section = {this.state.error_section}
                        ...
                        {updateQues && updateQues?.cardiac_problems === "yes" && (
                          <CPSection updateAllEntrySec2={(e)=>{updateAllEntrySec2(e, this)}}
                          updateAllEntrySec = {(e, name)=>updateAllEntrySec(e, name, this)}
                          updateAllEntrySec1 = {(e)=>updateAllEntrySec1(e, this)}
                          updateQues = {this.state.updateQues}
                          error_section = {this.state.error_section}
