...
function Index(props) {
  ...
  return (
    ...
    </Grid> <Grid className="fatiqueQues fatiqueQuess1">
    ...
    {props.updateQues &&
      props.updateQues?.stomach_have_diabetes === "yes" && (
        <>
          <Grid container direction="row" spacing="1">
            <Grid item md={6} sm={6}>
              <Grid className="fillDia">
                <MMHG
                  ...
                  value={
                    props.updateQues?.stomach_blood_sugar
                  }
                />
              </Grid>
    ...
    <Grid className="fatiqueQues fatiqueQuess1">
      <FatiqueQuestion
        ...
        value={
          props.updateQues?.stomach_continuously_or_periodically
        }
      />
      </Grid>
    </Grid>
    ...
    <Grid className="bgncmnSpc">
      ...
      <PainIntensity
        ...
        onChange={(e) => props.updateAllEntrySec1(e)}
        value={Math.round(
          props.updateQues?.stomach_pain_intensity
        )}
