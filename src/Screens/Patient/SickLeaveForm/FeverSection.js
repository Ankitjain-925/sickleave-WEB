  ...
  return (
    ...
    <Grid className="bgncmnSpc">
      ...
      <Grid>
        <DateFormat
          ...
          max={new Date()}
          onChange={(e) =>
            props.updateAllEntrySec(e, "fever_symptoms_begin")
          }
          // date_format={
          //   this.props.settings &&
    ...
    <Grid className="bgncmnSpc">
      ...
      <PainIntensity
        ...
        value={Math.round(
          props.updateQues?.fever_pain_intensity
        )}
    ...
    {props.updateQues &&
      props.updateQues?.fever_have_a_cough === "yes" && (
    ...
    <Grid className="fillDiaAll">
      ...
      <NotesEditor
        name="fever_sputum"
        onChange={(e) =>
          props.updateAllEntrySec(e, "fever_sputum")
        }
